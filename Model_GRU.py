...
def get_Model(training):
    ...
    # RNN layer
    gru_1 = GRU(256, return_sequences=True, kernel_initializer='he_normal', name='gru1')(inner)  # (None, 32, 256)
    ...
    gru1_merged = add([gru_1, reversed_gru_1b])  # (None, 32, 256)
    ...
    gru2_merged = concatenate([gru_2, reversed_gru_2b])  # (None, 32, 512)
